            ...
            <div className="container mx-auto px-4 md:px-8">
                <div className="flex flex-col gap-6 md:gap-10 mx-auto ml-14 md:ml-16 lg:ml-20">
                    ...
                    <div className="relative w-full ml-6">
                        <div className="absolute top-0 left-0 w-10 h-56 bg-gradient-to-r from-white to-transparent z-10 pointer-events-none"></div>
                        <div ref={carouselRef} className="flex gap-4 overflow-x-hidden">
                            {Array.from({ length: 10 }).map((_, index) => (
                                <div
                                    ...
                                    key={index}
                                >
                                    <div className="flex rounded-md aspect-square bg-muted items-center justify-center p-2 md:p-6 bg-green-50">
